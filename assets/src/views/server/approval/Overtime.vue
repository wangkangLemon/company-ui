...
<template>
<article id="approval-overtime-container">
    ...
    <section class="search">
        ...
        <section>
            <i>法定节假日</i>
            <el-select v-model="fetchParam.is_holiday" placeholder="未选择" @change="fetchData">
...
<!--         <section>
    ...
    <el-table class="data-table" v-loading="loadingData" :data="dataList" :fit="true" border>
            ...
            <el-table-column prop="fields.isHoliday" label="法定节假日" width="120" >
            </el-table-column>
            <el-table-column prop="fields.accountingType" label="加班核算方式" width="130" >
            </el-table-column>
            <el-table-column prop="create_time_name"label="提交时间" width="170" >
            </el-table-column>
            <el-table-column  prop="fields.overtimeHours" label="加班时长" width="100">
                <template slot-scope="scope">
                    {{scope.row.fields.overtimeHours}} 小时
                </template>
            </el-table-column>
            <el-table-column  prop="fields.beginTime" label="开始时间" width="170">
            </el-table-column>
            <el-table-column width="170" prop="fields.overTime" label="结束时间">
            </el-table-column>
            <el-table-column min-width="200" prop="fields.overtimeReason" label="加班理由">
            </el-table-column> 
          ...
          <el-dialog title="审批详情" :visible.sync="showdialog" >
            <el-form  label-width="100px" v-if="row">
                ...
                <el-form-item  label="加班时长：">
                    {{row.fields.overtimeHours}} 小时
                </el-form-item>
                 
                <el-form-item  label="加班理由：">
                    {{row.fields.overtimeReason}}
                </el-form-item>
                 <el-form-item  label="加班核算方式：">
                    {{row.fields.accountingType}}
                </el-form-item>
