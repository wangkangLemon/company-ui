...
<template>
    <main id="newcourse-course-public-container">
        <section class="manage-container">
            <el-button type="primary" icon="el-icon-plus" @click="$router.push({name: 'newcourse-course-add',query:{course_type:'private'}})" v-operation="auth.com_course_create"><i>添加课程</i>
            </el-button>
        ...
        <el-table class="data-table" v-loading="loadingData" :data="data" :fit="true" @select="selectRow" @select-all="selectRow" border>
            ...
            <el-table-column fixed="right" width="150" label="操作">
                <template slot-scope="scope">
                    ...
                    <el-button 
                        @click="$router.push({name: 'newcourse-course-edit', params: {course_id: scope.row.id},query:{course_type:'private'}})" 
                        type="text" 
                        size="small" 
