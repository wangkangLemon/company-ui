<style lang="scss">
    ...
    #member-selling-medicine-detail-container {
        @extend %content-container;
    }
</style>

<template>
    <main id="member-selling-medicine-detail-container">
...
<script>
    ...
    export default {
        ...
        created () {
            this.fetchParam.medicine_id = this.$route.query.medicine_id
            if (this.$route.query.time) {
                xmview.setContentTitle(`${this.$route.query.name} - ${this.$route.query.time}`)
            } else {
        ...
        methods: {
            fetchData () {
                this.loading = true
                return sellingService.searchDetailedMedicine(this.fetchParam).then(ret => {
                    this.data = ret.list
