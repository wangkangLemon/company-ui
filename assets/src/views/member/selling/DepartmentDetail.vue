<style lang="scss">
    ...
    #member-selling-department-detail-container {
        @extend %content-container;
    }
</style>

<template>
    <main id="member-selling-department-detail-container">
...
<script>
    ...
    export default {
        ...
        methods: {
            fetchData () {
                this.loading = true
                return sellingService.searchDetailedDepartment(this.fetchParam).then(ret => {
                    this.data = ret.list
