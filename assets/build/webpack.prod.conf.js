...
var webpackConfig = merge(baseWebpackConfig, {
    ...
    plugins: [
        ...
        new webpack.DefinePlugin({
            ...
            'process.oldCompanyDomain': '"https://admin.yst.vodjk.com"',
            'process.payUrl': config.build.payUrl,
        ...
        new HtmlWebpackPlugin({
            ...
            statisticsjs: config.build.assetsPublicPath + config.build.assetsSubDirectory + '/statistics.js?v=' + utils.getMd5(path.resolve('./public/statistics.js'))
        }),
